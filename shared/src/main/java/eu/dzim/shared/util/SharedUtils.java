...
public class SharedUtils {
	...
	public static String enumValueToString(Resource resource, Enum<?> enumeration) {
		return BaseEnumType.class.isAssignableFrom(enumeration.getClass()) ? resource.getGuaranteedString(((BaseEnumType) enumeration).getKey())
	...
	public static WindowSetup windowSetup(Stage stage, ConfigService configService) {
		...
		ObservableList<Screen> intersect = Screen.getScreensForRectangle(windowSetup.getPosX(), windowSetup.getPosY(), windowSetup.getWidth(),
				windowSetup.getHeight());
