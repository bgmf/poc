...
public class SimpleDialog extends StackPane {
    ...
    private void initDecoratedDialogPosition() {
        ...
        case TOP_CENTER:
            contentHolder.translateXProperty().bind(Bindings
                    .createDoubleBinding(() -> dialogContainer.getLayoutBounds().getWidth() / 2.0 - contentHolder.getLayoutBounds().getWidth() / 2.0,
        ...
        case TOP_RIGHT:
            contentHolder.translateXProperty().bind(Bindings
                    .createDoubleBinding(() -> dialogContainer.getLayoutBounds().getWidth() - contentHolder.getLayoutBounds().getWidth(),
                            dialogContainer.layoutBoundsProperty(), contentHolder.layoutBoundsProperty()));
            contentHolder.setTranslateY(0.0);
            break;
        ...
        case BOTTOM_CENTER:
            contentHolder.translateXProperty().bind(Bindings
                    .createDoubleBinding(() -> dialogContainer.getLayoutBounds().getWidth() / 2.0 - contentHolder.getLayoutBounds().getWidth() / 2.0,
                            dialogContainer.layoutBoundsProperty(), contentHolder.layoutBoundsProperty()));
            contentHolder.translateYProperty().bind(Bindings
                    .createDoubleBinding(() -> dialogContainer.getLayoutBounds().getHeight() - contentHolder.getLayoutBounds().getHeight(),
                            dialogContainer.layoutBoundsProperty(), contentHolder.layoutBoundsProperty()));
            break;
        case BASELINE_LEFT:
            // intended fall-through
        ...
        case CENTER_LEFT:
            contentHolder.setTranslateX(0.0);
            contentHolder.translateYProperty().bind(Bindings.createDoubleBinding(
