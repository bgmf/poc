...
public class SimpleDialogEvent extends Event {
     ...
     *
     * @param source    the source of the event (e.g. the {@link SimpleDialog} instance)
     * @param target    the target of the event (e.g. the {@link SimpleDialog}'s content container)
     * @param eventType the event type
     */
