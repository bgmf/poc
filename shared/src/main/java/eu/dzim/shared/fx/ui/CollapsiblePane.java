...
public class CollapsiblePane extends BorderPane {
	
	private static final Logger LOG = Logger.getLogger(CollapsiblePane.class.getName());
	...
	private void buildUI() {
		...
		collapsibleButton = new CollapsibleButton();
