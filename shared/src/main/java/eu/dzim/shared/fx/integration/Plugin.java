...
public interface Plugin extends Disposable {
	 ...
	 * 
	 * @param parentStage
	 *            the parent {@link Stage} object (e.g. from a root application, where the plugin is integrated into)
	 * @param baseCssUrl
	 *            a {@link URL} to a common root CSSm if applicable
	 * @param additionalParameters
	 *            a {@link Map} of additional parameters for the plugin, if applicable
	 * 
	 * @throws PluginException
	 *             when the data is incomplete (missing fields on {@link ProjectData}, ...) and the plugin can therefore not be initialized
	 */
	 ...
	 * 
	 * @throws PluginException
	 *             might be thrown, if the icon cannot be loaded
	 */
	 ...
	 * 
	 * @throws PluginException
	 *             might be thrown, if the UI cannot be loaded
	 */
	 ...
	 * 
	 * @param description
	 *            a specific file, encapsulated within a {@link Description} object, to load
	 * @param additionalParameters
	 *            a {@link Map} of additional parameters for the plugin, if applicable
	 * 
	 * @throws PluginException
