...
public interface ConfigService {
	 ...
	 * 
	 * @param configDir
	 *            the {@link Path}, where the projects configuration should be stored at.
	 */
	 ...
	 *            a generic window data value
	 * @param update
	 *            <code>true</code>, if this operation should trigger the {@link #update()} operation (file system operation)
	 * @return <code>true</code>, if the operation was successful
	 */
	 ...
	 * 
	 * @param recentEntry
	 *            the {@link RecentEntry} to add to the internal list
	 * @return <code>true</code>, if the operation was successful
	 */
