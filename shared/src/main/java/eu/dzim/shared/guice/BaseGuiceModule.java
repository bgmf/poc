...
public abstract class BaseGuiceModule extends AbstractModule {
     ...
     *
     * @param resource         the concrete {@link Resource} (see {@link #resource})
     * @param stage            the JavaFX applications primary {@link Stage} (see {@link #stage})
     * @param applicationModel the concrete application model (see {@link #applicationModel})
     * @param objectMapper     the base {@link ObjectMapper} (see {@link #objectMapper})
     */
     ...
     *
     * @param configDir the directory, where the configuration file is located in
     */
