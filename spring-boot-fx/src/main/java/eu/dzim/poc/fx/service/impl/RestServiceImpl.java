...
public class RestServiceImpl implements RestService {
    ...
    @Value("${remote.protocol:http}") private String mRemoteProtocol;
    @Value("${remote.host:localhost}") private String mRemoteHost;
    @Value("${remote.port:8080}") private String mRemotePort;
    @Value("${remote.path:/rest}") private String mRemoteBasePath;
