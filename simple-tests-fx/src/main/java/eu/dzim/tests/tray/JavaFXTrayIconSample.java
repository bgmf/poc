    ...
    private void addAppToTray() {
        try {
            ...
            notificationTimer.schedule(new TimerTask() {
                @Override
                public void run() {
                    javax.swing.SwingUtilities.invokeLater(() -> trayIcon
                            .displayMessage("hello", "The time is now " + timeFormat.format(new Date()), java.awt.TrayIcon.MessageType.INFO));
                }
            }, 5_000, 60_000);

            trayIcon.setActionCommand("test");
            ...
            trayIcon.addMouseListener(new MouseListener() {
                ...
                public void mouseClicked(MouseEvent e) {
                    System.err.println("click: " + e.getClickCount());
                }
            });
